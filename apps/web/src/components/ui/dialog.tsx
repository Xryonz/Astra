  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-popover text-popover-foreground border border-border rounded-2xl',
        'p-6 shadow-2xl',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0',
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-md opacity-60 hover:opacity-100 transition-opacity outline-none focus:ring-2 focus:ring-ring/40"
        aria-label="Fechar"
      >
        <X className="size-4" />
      </DialogPrimitive.Close>
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-lg leading-none tracking-tight font-display', className)}
