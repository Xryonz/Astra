...
- 2026-06-18: M6d.1 RECEBER tela VALIDADO no device (web compartilha -> nativo ve tile da tela). Falta so M6d.2 (transmitir via MediaProjection) pra fechar o M6. Depois: app desktop nativo.
