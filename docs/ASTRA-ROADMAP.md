...
- 2026-06-18: M6a 100% VALIDADO no device — voz nativa funcionando (falar/ouvir) e sobrevivendo ao background. LIVEKIT_* confirmado setado na Railway. Proximo: M6b (UI de participantes: quem fala, mute/deafen, presence).
