...
- 2026-06-18: M6c video de camera ESCRITO + APK assembleDebug OK. livekit-android-compose-components 2.4.0 (VideoTrackView, usei o overload de VideoTrack cru + passedRoom pra ligar no meu VoiceManager sem RoomScope). Grid 2col de tiles (camera ou avatar), permissao CAMERA opcional. Falta validar no device. Proximo: M6d (screenshare 60fps via MediaProjection — o gamer).
