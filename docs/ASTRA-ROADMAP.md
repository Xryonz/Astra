...
- 2026-06-18: M6b painel de participantes VALIDADO no device (2 contas): avatar+nome real (via /members), anel ambar em quem fala, icone mic mudo, deafen funcionando. Proximo: M6c (video de camera).
