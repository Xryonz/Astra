...
- 2026-06-18: M5a servidores + canais escrito+compila — lista de servidores (GET /api/servers), criar servidor por nome, lista de canais (TEXT clicavel, VOICE desabilitado=M6), nav Home->Servidores->Canais. Falta validar runtime.
