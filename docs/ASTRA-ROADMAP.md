...
- [~] M9 Contas+social (paridade com o web; register/amigos/perfil + Home virou hub). Compila + assembleDebug OK; falta validar no device. Fatiado:
  ...
  - BACKLOG Home (versao enxuta shipada; extras adiados): busca inline por nome, timestamp relativo (relativeShort), prefixo "Você:" qd lastFromMe, BottomUserBar c/ sino, glyphs Canvas (Search/Bell/Compose).
