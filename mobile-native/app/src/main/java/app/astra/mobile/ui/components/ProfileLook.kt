...
val ProfileGradients: List<Pair<String, String>> = listOf(
    "Amanhecer" to "linear-gradient(135deg,#ff6b9d,#ff9874,#ffd6a5)",
    "Coral" to "linear-gradient(135deg,#ff7e5f,#feb47b)",
    "Pétala" to "linear-gradient(135deg,#ffafbd,#ffc3a0)",
    "Pôr do sol" to "linear-gradient(135deg,#fc4a1a,#f7b733)",
    "Brasa" to "linear-gradient(135deg,#ff5722,#ff9800,#ffc107)",
    "Magma" to "linear-gradient(135deg,#f12711,#f5af19)",
    "Âmbar" to "linear-gradient(135deg,#d97706,#facc15)",
    "Açafrão" to "linear-gradient(135deg,#ee9b00,#ca6702)",
    "Menta" to "linear-gradient(135deg,#11998e,#38ef7d)",
    "Salgueiro" to "linear-gradient(135deg,#7a9e7e,#c8d5b9)",
    "Musgo" to "linear-gradient(135deg,#5a7140,#a1aa6d)",
    ...
    "Ártico" to "linear-gradient(135deg,#a1c4fd,#c2e9fb)",
    "Bruma" to "linear-gradient(135deg,#bdc3c7,#2c3e50)",
    "Cyber" to "linear-gradient(135deg,#6e57e0,#4fc3f7,#00d4ff)",
    "Crepúsculo" to "linear-gradient(135deg,#3a1c71,#4a00e0)",
    "Plasma" to "linear-gradient(135deg,#8e2de2,#4a00e0,#f12711)",
    "Aurora" to "linear-gradient(135deg,#3a1c71,#d76d77,#ffaf7b)",
    "Lavanda" to "linear-gradient(135deg,#8e44ad,#c39bd3)",
    "Veludo" to "linear-gradient(135deg,#41295a,#2f0743)",
    "Neon" to "linear-gradient(135deg,#ff00cc,#333399)",
    "Vinho" to "linear-gradient(135deg,#6e0d25,#bd5734)",
    "Borgonha" to "linear-gradient(135deg,#600000,#9c1f1f)",
    ...
    "Carvão" to "linear-gradient(135deg,#232526,#414345)",
    "Ônix" to "linear-gradient(135deg,#0c0c0c,#3c3c3c)",
)
