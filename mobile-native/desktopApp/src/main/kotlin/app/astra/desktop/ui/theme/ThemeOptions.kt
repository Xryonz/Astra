...
val ThemePresets = listOf(
    ...
    ThemePreset("solar", "Solar", "Âmbar editorial", "gold", "void"),
    ThemePreset("nebula", "Nebulosa", "Violeta cósmica", "violet", "navy"),
    ThemePreset("aurora", "Aurora", "Ciano + floresta", "teal", "forest"),
    ThemePreset("eclipse", "Eclipse", "Carmim sobre vinho", "crimson", "wine"),
    ThemePreset("meridian", "Meridiano", "Esmeralda + carvão", "emerald", "dark"),
    ...
    // temperatura certa.
    ThemePreset("nortada", "Nortada", "Ardósia no gelo", "slate", "arctic"),
    ThemePreset("terracota", "Terracota", "Cobre sobre terra", "copper", "clay"),
    ThemePreset("equinocio", "Equinócio", "Índigo de cidade", "indigo", "indigo-night"),
    ThemePreset("penumbra", "Penumbra", "Lilás abafado", "lilac", "mauve"),
    ThemePreset("maresia", "Maresia", "Ciano + petróleo", "teal", "petrol"),
    ThemePreset("musgo", "Musgo", "Salva + oliva", "sage", "olive"),
    ThemePreset("poeira", "Poeira Estelar", "Violeta em bruma", "violet", "haze"),
    ThemePreset("vespera", "Véspera", "Cobalto discreto", "cobalt", "lead"),
)
